"""
Database module - completed reference version with connection pooling.
"""
...
_pool = ConnectionPool(
    conninfo=os.environ.get("DATABASE_URL", "postgresql://workshop:workshop@localhost:5432/bookstore"),
