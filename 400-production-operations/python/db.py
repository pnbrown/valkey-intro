...
Carries forward the completed query functions from the 300-level.
You will replace get_connection() with a connection pool in Part A1.
"""
...
def get_connection():
    ...
    See Part A1 in the README for the pooled version."""
